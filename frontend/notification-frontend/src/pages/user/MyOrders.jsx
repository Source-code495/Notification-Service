...
export default function MyOrders() {
  ...
  const columns = useMemo(() => [
      ...
      },
      {
          key: "created_at",
          title: "Order Date",
          render: (r) => <span className="text-slate-700 dark:text-slate-300">{formatDateTime(r.created_at)}</span>
      },
      {
          key: "estimated_delivery",
          title: "Est. Delivery",
          render: (r) => <span className="text-slate-700 dark:text-slate-300">{formatDateTime(r.estimated_delivery)}</span>
      },
      {
          key: "total_amount",
          title: "Amount",
      ...
      },
      {
          ...
          title: "Actions",
          render: (r) => (
              <Button variant="secondary" className="!p-1.5" onClick={() => setSelectedOrder(r)}>
        ...
        >
            <div className="space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 pb-4 dark:border-slate-800">
                    ...
                    <div>
                         <Badge color={statusColor(selectedOrder.status)}>{selectedOrder.status.replace(/_/g, ' ')}</Badge>
                    </div>
                </div>
