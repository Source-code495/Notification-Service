...
export default function AdminCampaigns() {
        ...
        render: (c) => (
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={(e) => {
                e?.stopPropagation?.();
                navigate(`/admin/campaigns/${c.campaign_id}/recipients`);
              }}
            >
            ...
            <Button
              ...
              onClick={async (e) => {
                ...
                try {
                  ...
                  setSuccess(
                    `${res?.message || "Campaign sent"} (recipients: ${
                      res?.recipients ?? "?"
                    })`
                  );
                  await fetchPage();
  ...
  return (
    <div>
      <PageHeader
        title="Campaigns"
        subtitle="Create campaigns with optional city filters (send to all if none) and send to eligible users based on preferences."
      />
          ...
          <form className="space-y-3" onSubmit={onCreate}>
            <FormField label="Campaign name">
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, campaign_name: e.target.value }))
                }
                required
              />
            </FormField>
            ...
            <FormField label="Message">
              <textarea
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, campaign_message: e.target.value }))
                }
                required
              />
            </FormField>
