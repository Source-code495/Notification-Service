...
function ToggleRow({ label, checked, hint }) {
  return (
    <label className="flex items-start justify-between gap-4 rounded-lg border border-slate-200 bg-white px-3 py-3 opacity-70 dark:border-slate-800 dark:bg-slate-950">
      <div>
...
async function onSave() {
  ...
  try {
    await updateUser(user.user_id, { city });
